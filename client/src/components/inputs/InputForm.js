    ...
    return (
        <div className={clsx('flex flex-col h-[42px] gap-2 ', style)}>
            ...
            <input
                ...
                className={clsx('form-input my-auto rounded-lg ', disable && 'bg-gray-400', fullWidth && 'w-full', txtSmall && 'text-sm', transform && 'hover:w-[350px] hover:-translate-x-12 duration-300 ')}
            />
